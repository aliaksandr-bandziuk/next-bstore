      ...
      <nav className='h-full max-w-screen-xl mx-auto px-4 xl:px-0 flex items-center justify-between gap-2'>
        ...
        <div className='relative w-full hidden lg:inline-flex lg:w-[600px] h-10 text-base text-primeColor border-[1px] border-black items-center gap-2 justify-between px-6 rounded-md'>
          <input
            ...
            className='flex-1 h-full bg-transparent outline-none placeholder:text-gray-600'
        ...
        <div className='hidden md:inline-flex items-center gap-2'>
          ...
          {session?.user && (
            <button
              onClick={() => signOut()}
              className='flex justify-center items-center hover:font-medium w-20 h-6 px-12 text-gray-500 hover:underline underline-offset-4 decoration-[1px] hover:text-red-600 md:border-r-[2px] border-r-gray-300 duration-200 last:border-r-0'
            >
              Logout
            </button>
          )}
